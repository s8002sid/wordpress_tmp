...
class WOOC_Widget_Cart extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'Shopping Cart', 'woocommerce' ) : $instance['title'], $instance, $this->id_base );
