...
<?php if (Helix::Param('show_helix_logo')) : ?>
	<div class="helix-framework">
		<a class="helix-logo" target="_blank" title="<?php _e('Powered by Vina Framework', _THEME) ?>" href="<?php echo esc_url( 'http://www.vinathemes.biz' ); ?>">
...
<span class="designed-by">Designed <a target="_blank" title="Premium Joomla Templates and Wordpress Themes" href="http://www.vinathemes.biz"> VinaThemes.biz </a></span>		
