...
class contact_info extends WP_Widget
{
	...
	function widget( $args, $instance )
	{
		...
		$text .= '  <ul>';
            $text .= ( !empty( $instance['address'] ) ) ? '<li>' . $address_image . __( 'Location', 'yit' ) . ': <strong>' . do_shortcode( $instance['address'] ) . '</strong></li>' : '';
            $text .= ( !empty( $instance['phone'] ) ) ? '<li>' . $phone_image . __( 'Phone', 'yit' ) . ': <strong> ' . do_shortcode( $instance['phone'] ) . '</strong></li>' : '';
            $text .= ( !empty( $instance['mobile'] ) ) ? '<li>' . $mobile_image . __( 'Mobile', 'yit' ) . ': <strong> ' . do_shortcode( $instance['mobile'] ) . '</strong></li>' : '';
            $text .= ( !empty( $instance['fax'] ) ) ? '<li>' . $fax_image .  __( 'Fax', 'yit' ) . ': <strong> ' . do_shortcode( $instance['fax'] ) . '</strong></li>' : '';
            $text .= ( !empty( $instance['email'] ) ) ? '<li>' . $email_image .  __( 'Email', 'yit' ) . ': <strong> ' . do_shortcode( $instance['email'] ) . '</strong></li>' : '';
		$text .= '  </ul>';
		$text .= '</div>'; 
