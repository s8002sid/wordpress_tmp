<?php 
$landing = 'http://yithemes.com/themes/wordpress/panthea-multi-purpose-e-commerce-theme/';
$live = 'http://demo.yithemes.com/panthea/';
...
$name = 'Panthea Ecommerce Theme';
$price = '65';
if ( false === ( $price = get_transient( 'yit_theme_price_' . get_template() ) ) ) {
    $requrl = 'http://yithemes.com/?wc-api=yit_theme_price&theme=panthea';
