...
function yit_setup_theme() {    
    ...
    $image_sizes = array(
        'blog_small_image' => array( 270, 270, true ),
        'blog_big'     => array( 873, 421, true ),
        'blog_thumb'   => array( 49, 49, true ),
        'section_blog' => array( 264, 105, true ),
        'section_blog_slider' => array( 285, 330, true),
        ...
        'thumb-testimonial' => array( 270, 220, true ),
        'thumb-testimonial-quote' => array( 160, 160, true ),
        'thumb-testimonial-featured' => array( 472, 290, true ),
        ...
        'teaser_widget' => array( 0, 310,true ),
    );
...
//     ) );
    ...
    register_sidebar( yit_sidebar_args( 'Header Left Sidebar', 'Widget area above the navigation on the left' ) );
    register_sidebar( yit_sidebar_args( 'Header Right Sidebar', 'Widget area above the navigation on the right' ) );
...
if (!function_exists("yit_get_teaser_title_class")){
    function yit_get_teaser_title_class( $width, $height ,$classHorizontal, $classVertical,$special_font) {

        $class_css= ($special_font=="no") ? "" : "special-font"  ;

        if ($width > $height) return $classHorizontal."".$class_css;
        else return $classVertical." ".$class_css;
    }
}


function yit_get_div_clear(){
