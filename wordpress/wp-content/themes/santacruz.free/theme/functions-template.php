...
if( !function_exists( 'yit_add_custom_styles' ) ) {
    function yit_add_custom_styles() {
        wp_enqueue_style( 'responsive', YIT_CORE_ASSETS_URL . '/css/responsive.css', array(), '1.0.0', 'all' );
        wp_enqueue_style( 'theme-responsive', get_template_directory_uri() . '/css/responsive.css', false, '2.0', 'all' );
        ...
        wp_enqueue_style( 'custom', $custom_css, array(), false, 'all', true );
    }
}
...
if( !function_exists( 'yit_welcome_menu' ) ) {
	function yit_welcome_menu() {
		yit_get_template( '/header/welcome-menu.php' );
	}
}
...
if( !function_exists( 'yit_before_footer' ) ) {
    function yit_before_footer() {
        yit_get_template( '/footer/footer-before.php' );
    }
}
...
/* === AUTHOR BOX TEMPLATE */
if( !function_exists('yit_author_box') ) {
    function yit_author_box(){
        yit_get_template('author/author.php');
    }
}
