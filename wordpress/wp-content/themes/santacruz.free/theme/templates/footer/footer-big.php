...
<!--        <div class="row pb15">-->
<!---->
<!--            <div class="span6 footer-before-left">-->
<!--                --><?php //echo stripslashes( yit_ssl_url( do_shortcode( yit_get_option( 'footer-row-left-text' ) ) ) ); ?>
<!--            </div>-->
<!--            <div class="span6 footer-before-right">-->
<!--                <div class = "social">-->
<!--                    --><?php //echo stripslashes( yit_ssl_url( do_shortcode( yit_get_option( 'footer-row-right-text' ) ) ) ); ?>
<!--                </div>-->
<!---->
<!--            </div>-->
<!--        </div>-->
<!--    </div>-->
<!---->
<!--    <div class="container wrap-big-footer">-->
<!--        <div class="row">-->
