...
// owl carousel
wp_register_script( 'owlcarousel', get_template_directory_uri() .'/theme/assets/js/owl-carousel.js', array('jquery'));
wp_register_style( 'owlcarousel', get_template_directory_uri() .'/theme/assets/css/owl-carousel.css' );
...
yit_enqueue_style( 10, 'author', YIT_THEME_TEMPLATES_URL . '/author/css/style.css' );
