...
$comment_args = array(
    ...
    'title_reply'          => __( 'LEAVE A COMMENT', 'yit' ),
    'title_reply_to'       => __( 'Leave a Reply to %s', 'yit' ),
    'cancel_reply_link'    => __( 'Cancel comment', 'yit' ),
    'label_submit'         => __( 'POST A COMMENT', 'yit' ),
);
...
<h3 id="comments-title">
    <?php comments_number( __('No comments', 'yit'), __('1 comment', 'yit'), __('% comments', 'yit') ); ?>
</h3>
<?php
