	...
	function widget( $args, $instance ) {
        ...
        <div class="yit_cart_widget widget_shopping_cart">
    		<div class="cart_label">
                <img class="hidden-phone" width="28" height="22" src="<?php echo YIT_THEME_URL?>/woocommerce/images/header-cart.png" alt="<?php _e('View Cart', 'yit') ?>" />
                <?php _e( 'Cart', 'yit' ) ?> / <?php list( $cart_items, $cart_subtotal, $cart_currency ) = yit_get_current_cart_info(); ?>
