...
add_action( 'wp_enqueue_scripts', 'yit_add_custom_styles', 999 );
...
add_action( 'yit_welcome_menu', 'yit_welcome_menu', 10 );
...
add_action( 'yit_before_comments', 'yit_author_box' );
...
add_action( 'yit_before_footer', 'yit_before_footer', 10 );
