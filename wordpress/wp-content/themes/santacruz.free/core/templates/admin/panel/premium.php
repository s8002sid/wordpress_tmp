<?php 
$landing = 'http://yithemes.com/themes/wordpress/santa-cruz-sell-everything-with-love/?utm_source=yith-panel&utm_medium=wpadmin&utm_content=tab-premium-santacruz&utm_campaign=yith-admin';
$live = 'http://live.yithemes.com/santa-cruz/';
...
$name = 'Santa Cruz Ecommerce Theme';
$price = '65';

if ( false === ( $price = get_transient( 'yit_theme_price_' . get_template() ) ) ) {
    $requrl = 'http://yithemes.com/?wc-api=yit_theme_price&theme=santacruz';
...
<div class="container bolder-tpl landing">
    ...
    <ul class="premium-features">
        ...
        <li>
            <img src="<?php echo $images_url ?>/zoom.jpg" alt="<?php echo $name ?>" />

            <h3>Zoom Product Image</h3>

            <p>
                To zoom the product image on your shop.
            </p>
        </li>

        <li>
            <img src="<?php echo $images_url ?>/wishlist02.jpg" alt="<?php echo $name ?>" />

            <h3>Wishlist</h3>

            <p>
                to add whichever product you want to the list of your most desired elements .
            </p>
        </li>
