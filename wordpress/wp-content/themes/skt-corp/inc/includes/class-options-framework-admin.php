     ...
     */
	 function options_page() { ?>
	    ...
	    <h2 class="nav-tab-wrapper">
          ...
          <div style="padding-top:10px;font-size:15px;"><a href="<?php echo esc_url(SKT_THEME_URL_DIRECT); ?>" target="_blank"><?php _e('Buy PRO version for only $30 with more features.','skt-corp'); ?></a></div>
